...
multi() ->
	...
	% Listener 4 on {127,0,0,1}, localhost, path /dom4 and proto 'proto1'
	...
	% Url4 = "test://localhost:"++P1S++"/any;transport=ws",
 ...
 % 		#nkport{domain = dom4,transp = ws,
	% 		local_ip = {127,0,0,1}, local_port = P1,
	% 		listen_ip = {127,0,0,1},listen_port = P1,
